...
#include "interfaces_pkg/msg/detail/key_point3_d_array__rosidl_typesupport_fastrtps_c.h"
...
#include "interfaces_pkg/msg/detail/key_point3_d__functions.h"  // data
#include "rosidl_runtime_c/string.h"  // frame_id
#include "rosidl_runtime_c/string_functions.h"  // frame_id

// forward declare type support functions
size_t get_serialized_size_interfaces_pkg__msg__KeyPoint3D(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_interfaces_pkg__msg__KeyPoint3D(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces_pkg, msg, KeyPoint3D)();


using _KeyPoint3DArray__ros_msg_type = interfaces_pkg__msg__KeyPoint3DArray;
  ...
  // Field name: data
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, interfaces_pkg, msg, KeyPoint3D
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: data
  {
    ...
    if (ros_message->data.data) {
      interfaces_pkg__msg__KeyPoint3D__Sequence__fini(&ros_message->data);
    }
    if (!interfaces_pkg__msg__KeyPoint3D__Sequence__init(&ros_message->data, size)) {
...
size_t get_serialized_size_interfaces_pkg__msg__KeyPoint3DArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _KeyPoint3DArray__ros_msg_type * ros_message = static_cast<const _KeyPoint3DArray__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_interfaces_pkg__msg__KeyPoint3D(
...
static uint32_t _KeyPoint3DArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces_pkg__msg__KeyPoint3DArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces_pkg
size_t max_serialized_size_interfaces_pkg__msg__KeyPoint3DArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_interfaces_pkg__msg__KeyPoint3D(
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_pkg__msg__KeyPoint3DArray;
    is_plain =
      (
...
static size_t _KeyPoint3DArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces_pkg__msg__KeyPoint3DArray(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces_pkg, msg, KeyPoint3DArray)() {
