...
struct Detection_
{
  ...
  Type & set__bbox3d(
    const interfaces_pkg::msg::BoundingBox3D_<ContainerAllocator> & _arg)
  {
    this->bbox3d = _arg;
    return *this;
  }
  ...
  Type & set__keypoints(
    const interfaces_pkg::msg::KeyPoint2DArray_<ContainerAllocator> & _arg)
  {
    this->keypoints = _arg;
    return *this;
  }
  Type & set__keypoints3d(
    const interfaces_pkg::msg::KeyPoint3DArray_<ContainerAllocator> & _arg)
  {
