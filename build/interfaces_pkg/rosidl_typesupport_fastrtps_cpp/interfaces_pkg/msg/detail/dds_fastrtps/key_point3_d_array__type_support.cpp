...
#include "interfaces_pkg/msg/detail/key_point3_d_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const interfaces_pkg::msg::KeyPoint3D &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  interfaces_pkg::msg::KeyPoint3D &);
...
cdr_serialize(
  const interfaces_pkg::msg::KeyPoint3DArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces_pkg::msg::KeyPoint3DArray & ros_message)
{
  // Member: data
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        interfaces_pkg::msg::typesupport_fastrtps_cpp::max_serialized_size_KeyPoint3D(
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_pkg::msg::KeyPoint3DArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces_pkg::msg::KeyPoint3DArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces_pkg::msg::KeyPoint3DArray *>(
    untyped_ros_message);
...
get_message_type_support_handle<interfaces_pkg::msg::KeyPoint3DArray>()
{
  return &interfaces_pkg::msg::typesupport_fastrtps_cpp::_KeyPoint3DArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_pkg, msg, KeyPoint3DArray)() {
  return &interfaces_pkg::msg::typesupport_fastrtps_cpp::_KeyPoint3DArray__handle;
}
