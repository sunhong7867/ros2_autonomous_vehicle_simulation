...
#include "interfaces_pkg/msg/detail/vector2__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces_pkg::msg::Vector2 & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces_pkg::msg::Vector2 & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_pkg::msg::Vector2;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const interfaces_pkg::msg::Vector2 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces_pkg::msg::Vector2 *>(
    untyped_ros_message);
...
{
  return &interfaces_pkg::msg::typesupport_fastrtps_cpp::_Vector2__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_pkg, msg, Vector2)() {
  return &interfaces_pkg::msg::typesupport_fastrtps_cpp::_Vector2__handle;
}
