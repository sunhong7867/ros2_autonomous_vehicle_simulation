...
#include "interfaces_pkg/msg/detail/key_point2_d_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const interfaces_pkg::msg::KeyPoint2D &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  interfaces_pkg::msg::KeyPoint2D &);
...
cdr_serialize(
  const interfaces_pkg::msg::KeyPoint2DArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces_pkg::msg::KeyPoint2DArray & ros_message)
{
  // Member: data
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        interfaces_pkg::msg::typesupport_fastrtps_cpp::max_serialized_size_KeyPoint2D(
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_pkg::msg::KeyPoint2DArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces_pkg::msg::KeyPoint2DArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces_pkg::msg::KeyPoint2DArray *>(
    untyped_ros_message);
...
{
  return &interfaces_pkg::msg::typesupport_fastrtps_cpp::_KeyPoint2DArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_pkg, msg, KeyPoint2DArray)() {
  return &interfaces_pkg::msg::typesupport_fastrtps_cpp::_KeyPoint2DArray__handle;
}
