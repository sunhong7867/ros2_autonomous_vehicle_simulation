...
#include "interfaces_pkg/msg/detail/pose2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces_pkg::msg::Pose2D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces_pkg::msg::Pose2D & ros_message)
{
  // Member: position
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_pkg::msg::Pose2D;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces_pkg::msg::Pose2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces_pkg::msg::Pose2D *>(
    untyped_ros_message);
...
get_message_type_support_handle<interfaces_pkg::msg::Pose2D>()
{
  return &interfaces_pkg::msg::typesupport_fastrtps_cpp::_Pose2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_pkg, msg, Pose2D)() {
  return &interfaces_pkg::msg::typesupport_fastrtps_cpp::_Pose2D__handle;
}
