...
{
bool cdr_serialize(
  const interfaces_pkg::msg::BoundingBox3D &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const interfaces_pkg::msg::KeyPoint2DArray &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  interfaces_pkg::msg::KeyPoint2DArray &);
size_t get_serialized_size(
  const interfaces_pkg::msg::KeyPoint2DArray &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const interfaces_pkg::msg::KeyPoint3DArray &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  interfaces_pkg::msg::KeyPoint3DArray &);
size_t get_serialized_size(
  const interfaces_pkg::msg::KeyPoint3DArray &,
  size_t current_alignment);
size_t
  ...
  size_t current_alignment)
{
  ...
  // Member: bbox3d
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        interfaces_pkg::msg::typesupport_fastrtps_cpp::max_serialized_size_BoundingBox3D(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: keypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        interfaces_pkg::msg::typesupport_fastrtps_cpp::max_serialized_size_KeyPoint2DArray(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: keypoints3d
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        interfaces_pkg::msg::typesupport_fastrtps_cpp::max_serialized_size_KeyPoint3DArray(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_pkg::msg::Detection;
    is_plain =
      (
