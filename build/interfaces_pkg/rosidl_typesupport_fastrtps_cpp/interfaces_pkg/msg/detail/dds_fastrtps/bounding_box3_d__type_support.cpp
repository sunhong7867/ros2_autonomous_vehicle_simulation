...
#include "interfaces_pkg/msg/detail/bounding_box3_d__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_pkg::msg::BoundingBox3D;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces_pkg::msg::BoundingBox3D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces_pkg::msg::BoundingBox3D *>(
    untyped_ros_message);
...
get_message_type_support_handle<interfaces_pkg::msg::BoundingBox3D>()
{
  return &interfaces_pkg::msg::typesupport_fastrtps_cpp::_BoundingBox3D__handle;
}
