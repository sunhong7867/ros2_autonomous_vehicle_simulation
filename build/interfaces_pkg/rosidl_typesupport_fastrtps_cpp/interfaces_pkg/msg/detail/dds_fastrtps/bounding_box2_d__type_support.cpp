...
{
bool cdr_serialize(
  const interfaces_pkg::msg::Pose2D &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  interfaces_pkg::msg::Pose2D &);
...
{
bool cdr_serialize(
  const interfaces_pkg::msg::Vector2 &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  interfaces_pkg::msg::Vector2 &);
size_t get_serialized_size(
  const interfaces_pkg::msg::Vector2 &,
  size_t current_alignment);
size_t
  ...
  size_t current_alignment)
{
  ...
  // Member: center
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        interfaces_pkg::msg::typesupport_fastrtps_cpp::max_serialized_size_Pose2D(
  ...
  // Member: size
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        interfaces_pkg::msg::typesupport_fastrtps_cpp::max_serialized_size_Vector2(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_pkg::msg::BoundingBox2D;
    is_plain =
      (
