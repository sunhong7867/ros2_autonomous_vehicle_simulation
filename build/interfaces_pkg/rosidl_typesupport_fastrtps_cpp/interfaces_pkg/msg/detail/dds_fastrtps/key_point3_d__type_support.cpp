...
#include "interfaces_pkg/msg/detail/key_point3_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces_pkg::msg::KeyPoint3D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces_pkg::msg::KeyPoint3D & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_pkg::msg::KeyPoint3D;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces_pkg::msg::KeyPoint3D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces_pkg::msg::KeyPoint3D *>(
    untyped_ros_message);
...
get_message_type_support_handle<interfaces_pkg::msg::KeyPoint3D>()
{
  return &interfaces_pkg::msg::typesupport_fastrtps_cpp::_KeyPoint3D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_pkg, msg, KeyPoint3D)() {
  return &interfaces_pkg::msg::typesupport_fastrtps_cpp::_KeyPoint3D__handle;
}
