...
#include "interfaces_pkg/msg/detail/mask__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces_pkg::msg::Mask & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces_pkg::msg::Mask & ros_message)
{
  // Member: height
  cdr >> ros_message.height;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_pkg::msg::Mask;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces_pkg::msg::Mask *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces_pkg::msg::Mask *>(
    untyped_ros_message);
...
{
  return &interfaces_pkg::msg::typesupport_fastrtps_cpp::_Mask__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_pkg, msg, Mask)() {
  return &interfaces_pkg::msg::typesupport_fastrtps_cpp::_Mask__handle;
}
